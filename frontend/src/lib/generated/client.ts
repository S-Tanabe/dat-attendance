// Code generated by the Encore v1.51.4 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-da-template-ctqi.encr.app`
}
...
/**
 * Client is an API client for the da-template-ctqi Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "da-template-ctqi-Generated-TS-Client (Encore/v1.51.4)";
        }
