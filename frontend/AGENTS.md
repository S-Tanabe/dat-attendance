# Frontend開発ルール - dashboard-accelerator
...
このドキュメントは **Frontend開発者向けの開発ルールとワークフロー** をまとめたものです。
...
- **frontend/CLAUDE.md（本ドキュメント）**: Frontend開発ルール（機能説明は含めない）

### 🎯 本ドキュメントの役割

**Frontend固有の開発ルールとワークフローのみを記載します。**
